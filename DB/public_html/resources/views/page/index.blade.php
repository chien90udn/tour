...
<div class="grid-1 clear">
    ...
    <div id="l-dt-travelguide">
        <div id="box-txt-detail">
            ...
            {{--<p><img style="float: right;"src="{{ $page->photo }}"/>{{  $page->description }} </p>--}}
            <p>{!! $page->content !!}</p>
        </div>
        ...
        {{-- <div id="box-helpful-guide">
            ...
            @endphp
            <ul>
                <li><a href="javascript:;" class="bt-helpful" onclick="helpful('{{ $page->id }}')>','yes','message','{{ session('helpful') }}')">Yes</a><font id="message">Yes This article is useful to me</font></li>
                <li><a href="javascript:;" class="bt-helpful" onclick="helpful('{{ $page->id }}')>','no','message_no','{{ session('helpful') }}')">No</a><font id="message_no">This article is not useful</font></li>
