    @can('tours.cruises.index')
    @section('back', route('admin.tours.cruises.index'))
@endcan
<div class="row">
    <div class="col-xs-9">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-6">
                            <label for="name">Cruises Name</label>
                            <input type="text" name="name" id="name" value="{{ old('name', @$cruise->name) }}" class="form-control" placeholder="Enter Cruises name here">
                            @if($errors->has('name'))
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="number_hotel" id="number_hotel" value="{{ old('number_hotel', @$cruise->number_hotel) }}" class="form-control" placeholder="Enter number room here">
                            @if($errors->has('name'))
                                <div class="help-block text-danger">{{ $errors->first('name') }}</div>
                            @endif
                        </div>
                        <div class="col-md-3">
                            <label for="type_hotel"> Cruises Type</label>
                            <input type="text" name="type_hotel" id="type_hotel" value="{{ old('type_hotel', @$cruise->type_hotel) }}" class="form-control" placeholder="Enter type room here">
                            @if($errors->has('type_hotel'))
                                <div class="help-block text-danger">{{ $errors->first('type_hotel') }}</div>
                            @endif
                            {{-- {!! Form::select('type_hotel', ['0' => 'Please choose cruises type', '1' => 'City Hotel', '2' => 'Boutique Hotel', '3' => 'Beach Resort', '4' => 'Resort'], @$cruise->type_hotel, ['class' => 'form-control']) !!} --}}
                        </div>
                    </div>
                ...
                <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <h4 class="seo_plugin_title" data="title">{{ @$cruise->seo_title ? $cruise->seo_title  : @$cruise->name }}</h4>
                                <div class="seo_plugin_url">
                                    {{ url('/') }}/cruise/<strong data="url">{{ @$cruise->name_link ? $cruise->name_link  : 'sample-url' }}</strong>.html
                                </div>
                                <div class="seo_plugin_description" data="description">
                                    {!! @$cruise->seo_description ? $cruise->seo_description  : @$cruise->description !!}
                                </div>
                            </div>
                            <div id="form-seo" class="hidden">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        {!! Form::text('seo_title', @$cruise->seo_title ? @$cruise->seo_title : $cruise->name, ['class' => 'form-control', 'maxlength' => 70]) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        {!! Form::textarea('seo_description', @$cruise->seo_description ? $cruise->seo_description : strip_tags($cruise->description), ['class' => 'form-control', 'maxlength' => 160,'rows' => '2']) !!}
                ...
                <div class="form-group{{ $errors->has('tags') ? ' has-error' : '' }}">
                    ...
                    {{  Form::select('cat_id', $category, @$cruise->cat_id, ['class' => 'select2']) }}
                    @if($errors->has('cat_id'))
                        <div class="help-block text-danger">{{ $errors->first('cat_id') }}</div>
                    @endif
                </div>

                <div class="form-group{{ $errors->has('route') ? ' has-error' : '' }}">
                    <label for="location">Destination</label>
                    {{  Form::select('location', $destination, @$cruise->location, ['class' => 'select2']) }}
                ...
                <div class="form-group">
                    <div class="row">
                            <div class="col-md-6">
                                <label for="date_set">Launched</label>
                                <input type="text" name="date_set" id="date_set" value="{{ old('date_set', @$cruise->date_set) }}" class="form-control" placeholder="Enter launched here">
                                @if($errors->has('date_set'))
                                    <div class="help-block text-danger">{{ $errors->first('date_set') }}</div>
                                @endif
                            </div>
                            <div class="col-md-6">
                                <label for="address">Address</label>
                                <input type="text" name="address" id="address" value="{{ old('address', @$cruise->address) }}" class="form-control" placeholder="Enter address here">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            {!! Form::select('grade', ['2' => '2 stars','2.5' => '2 stars+','3' => '3 stars','3.5' => '3 stars+','4' => '4 stars','4.5' => '4 stars+','5' => '5 stars','5.5' => '5 stars+','6' => '6 stars','6.5' => '6 stars+','7' => '7 stars'], @$cruise->grade ?: '5', ['class' => 'form-control']) !!}
                            @if($errors->has('grade'))
                        ...
                        <div class="col-md-6">
                            ...
                            {!! Form::select('our_grade', ['2' => '2 stars','2.5' => '2 stars+','3' => '3 stars','3.5' => '3 stars+','4' => '4 stars','4.5' => '4 stars+','5' => '5 stars','5.5' => '5 stars+','6' => '6 stars','6.5' => '6 stars+','7' => '7 stars'], @$cruise->our_grade ?: '5', ['class' => 'form-control']) !!}
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input type="text" name="phone" id="phone" value="{{ old('phone', @$cruise->phone) }}" class="form-control" placeholder="Enter phone here">
                            @if($errors->has('phone'))
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="email" id="email" value="{{ old('email', @$cruise->email) }}" class="form-control" placeholder="Enter email here">
                            @if($errors->has('email'))
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="website" id="website" value="{{ old('website', @$cruise->website) }}" class="form-control" placeholder="Enter website here">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="skyper" id="skyper" value="{{ old('skyper', @$cruise->skyper) }}" class="form-control" placeholder="Enter skype here">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="">
                     ...
                     <li class="">
                        <a href="#promotion" data-toggle="tab" aria-expanded="false">
                            <span class="visible-xs"><i class="fa fa-user"></i></span>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="oveview">
                        ...
                        <div class="form-group {{ $errors->has('oveview') ? ' has-error' : '' }}">
                            <textarea name="oveview" id="oveview" rows="4" class="form-control simple_editor">{{ old('name', @$cruise->description) }}</textarea>
                        ...
                        {{-- <div class="form-group {{ $errors->has('point_of_view') ? ' has-error' : '' }}">
                            ...
                            <textarea name="point_of_view" id="point_of_view" rows="4" class="form-control simple_editor">{{ old('name', @$cruise->point_of_view) }}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('tags') ? ' has-error' : '' }}">
                            ...
                            <input name="tags" id="tags" class="form-control" value="{{ old('tags', @$cruise->tags)  }}" />
                            @if($errors->has('tags'))
                        ...
                        <div class="form-group {{ $errors->has('detail') ? ' has-error' : '' }}">
                            <label for="tags">Detail</label>
                            <textarea name="detail" id="detail" rows="4" class="form-control simple_editor">{{ old('name', @$cruise->detail) }}</textarea>
                    ...
                    <div class="tab-pane" id="facilities">
                        ...
                        <div class="form-group{{ $errors->has('groups') ? ' has-error' : '' }}">
                            ...
                            <textarea name="fac_high" class="form-control editor"><{{ old('fac_high', @$cruise->fac_high)  }}/textarea>
                        ...
                        <?php
                            if(isset($cruise)){
                                $arr_fac = explode("#",$cruise["facilities"]);
                                if(count($arr_fac) > 1) {
                    ...
                    {{-- <div class="tab-pane" id="dining">
                        @php
                            $dining_edit = explode("#", $cruise["dining"]);
                    ...
                    <div class="tab-pane" id="room">
                        <?php
                        if(isset($cruise)){
                            $arr_price = explode("#",$cruise["price_e"]);
                        }
                        ?>
                        <input type="hidden" name="roomTotal" id="roomTotal" value="{{ count($arr_price) }}">
                        @for($j=0;$j<count($arr_price);$j++)
                            @php
                                $k = $j+1;
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <input type="text" name="roomtype{{ @$k }}" id="roomtype{{ @$k }}" value="{{ old('roomtype', @$arr_p1[0]) }}" class="form-control" placeholder="Enter roomtype here">
                    ...
                    <div class="tab-pane" id="review">
                        <?php
                        if(isset($cruise)){
                            $rev_data = explode("#", $cruise["review"]);
                        }
                        ?>
                        @if(isset($cruise))
                    ...
                    <div class="tab-pane" id="promotion">
                        ...
                        @if(@$cruise->promotion)
                        @foreach(collect($cruise->promotion)->chunk(2) as $promotion)
                        @php $view = $promotion->values(); @endphp
                        <div class="form-group {{ $errors->has('promotion') ? ' has-error' : '' }}">
                            <input type="text" name="promotion[]" class="form-control" placeholder="Promotion Title" value="{{ @$view[0] }}">
                            <textarea name="promotion[]" id="promotion" rows="3" class="form-control simple_editor">{{ @$view[1] }}</textarea>
                            @if($errors->has('promotion'))
                                <div class="help-block text-danger">{{ $errors->first('promotion') }}</div>
                            @endif
                        </div>
                        <hr>
                        @endforeach
                        @else
                        <div class="form-group {{ $errors->has('promotion') ? ' has-error' : '' }}">
                            <input type="text" name="promotion[]" class="form-control" placeholder="Promotion Title" value="">
                            <textarea name="promotion[]" id="promotion" rows="3" class="form-control simple_editor"></textarea>
                            @if($errors->has('promotion'))
                                <div class="help-block text-danger">{{ $errors->first('promotion') }}</div>
                            @endif
                        </div>
                        ...
                        <button type="button" class="btn btn-success btn-sm m-b-5" onclick="addPromotion()">Add Promotion</button>
                    </div>
                ...
                {{-- <div class="tab-content">
                    <div class="tab-pane active" id="meeting">
                        @php
                            $meeting_arr = explode("#", $cruise["meeting_rooms"]);
                        @endphp                        
                    ...
                    <div class="tab-pane" id="time">
                        <div class="form-group {{ $errors->has('time_text') ? ' has-error' : '' }}">
                            ...
                            <textarea name="time_text" id="time_text" rows="3" class="form-control simple_editor">{{ old('name', @$cruise->times_distances) }}</textarea>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-bordered row draggable-blocks ui-sortable"
                     id="images">
                    @if($cruise->photo_e) @foreach(explode('|',$cruise->photo_e) as $image)
                        <div class="image-item col-md-2 col-sm-2 col-xs-2">
                            <img src="{{ $image }}" alt="">
                            <button class="btn btn-danger btn-xs delete-image" type="button">
                                <i class="fa fa-trash-o"></i> <span class="sr-only">delete</span>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <input type="number" name="price" min="0" id="price" value="{{ old('price', @$cruise->price ?: 0) }}" class="form-control" >
                    @if($errors->has('price'))
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="discount" id="discount" value="{{ old('discount', @$cruise->discount?: 0) }}" class="form-control" placeholder="Enter discount here">
            ...
            <div class="panel-body">
                <div class="form-group">
                    <div class="choose-thumbnail">
                        {!! Form::hidden('photo', @$cruise->photo, ['id' => 'photo']) !!}
                    </div>
                </div>
            </div><!-- panel-body -->
        </div> <!-- panel -->
