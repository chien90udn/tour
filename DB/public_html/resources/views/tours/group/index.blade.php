...
<div id="banner-cat">
    <div id="gadient">&nbsp;</div>
    <a href="/" title="{{ get_option('site_name') }}"><img src="{{ @$category->bg }}"></a>
    <div id="container-txtcat">
        <div class="grid-1">
            ...
            <div id="right-expert">
                <a href="javascript:;"><img src="/storage/public/member/sup2.jpg" alt="Send an Enquiry"></a>
                <div id="item-expert">
...
<div class="main-group">
    ...
    <div id="container-scrolltours" class="tour-top-10-pages" style="padding:0;margin-top: 30px; margin-bottom:30px;"> 

        <div class="grid-1 clear">
            <div id="title-line" style="margin-bottom:0;">
                <h1>{{ $category->name }}<span class="line"></span></h1>
            </div>
            {!! $category->detail !!}
        </div>
    </div>
    ...
    <div class="grid-1">
        ...
        <div id="best-tour2">
            <div id="img-tour">
                <div id="img-tour">
                    ...
                    @if($tour->discount)
                    <div class="sale">- {{ round(($tour->discount/($tour->price+$tour->discount)*100),0) }}%</div>
                    @endif
                    <!-- add new image -->
                    <!-- end new image -->
        ...
        <div id="show2">
            <div id="view-all-tour">
                ...
                <div id="show-tour">
                    <a href="javascript:void(0);" onclick="show_more_tours('{{ $category->name_link }}',1)" class="bt-moretour">...View More...</a>
                </div>
...
<div class="grid-1 clear">
    <div id="title-line" style="margin-bottom: 10px;">
        <h2>Multi-country Tours<span class="line"></span></h2>
    </div>
</div>
<div class="grid-1">
