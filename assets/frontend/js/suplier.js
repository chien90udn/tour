...
function cruise_search(type){
    if (document.form_check_booking_halong.con_sel_cruise.value == ""){
...
function cruise_search1(){
    ...
    if(document.form_check_booking_halong.check_in.value == d.formatdate("MM/dd/yyyy")){
        cruise_check_err(".div_check_in");
        return;
    }else{
        $(".div_check_in").css("border","none");
    }
    if(document.form_check_booking_halong.check_in.value == "" || document.form_check_booking_halong.check_in.value == "Check in"){
        nocheckin = true;
        //cruise_check_err(".div_check_in");
        //return;
    }else{
    ...
    if(document.form_check_booking_halong.package_vir.value == ""){
        alert("Please select your package. Thanks!");
        return;
    }
    if(document.form_check_booking_halong.nocabin.value < 1){
        cruise_check_err(".div_sel_cabin");
        return;
    }else{
        $(".div_sel_cabin").css("border","none");
    }
    var textseach = document.form_check_booking_halong.con_sel_cruise.value;
    $("#updating").show();
    $.ajax({
        type: "GET",
        ...
        success: function (xml) {
            ...
            if (Number(arr_html[1]) == 1) {
                document.form_check_booking_halong.search_cruise_id.value = arr_html[0];
                document.form_check_booking_halong.action = document.form_check_booking_halong.action + arr_html[2] + ".html";
                document.form_check_booking_halong.submit();
            } else if (Number(arr_html[1]) == 0 && Number(arr_html[2]) != "") {
                document.form_check_booking_halong.search_cruise_id.value = arr_html[0];    
                if(nocheckin!=true){            
                    document.form_check_booking_halong.action = document.form_check_booking_halong.action + arr_html[2] + "/booking.html";
                }else{
                    document.form_check_booking_halong.action = document.form_check_booking_halong.action + arr_html[2] + ".html";                  
                }                
                document.form_check_booking_halong.submit();
                ...
                if(sear_cruise==1){
                    document.form_check_booking_halong.action = document.form_check_booking_halong.action + "search.html";
                    document.form_check_booking_halong.submit();    
                }else{
                    cruise_search();    
                }
...
function cruise_search2() {
    ...
    if (document.form_check_booking_halong.noguest.value < 1) {
    ...
    $.ajax({
        ...
        success: function (xml) {
            ...
            if (Number(arr_html[1]) ==4) {
                document.form_check_booking_halong.search_cruise_id.value = arr_html[0];
                document.form_check_booking_halong.action = document.form_check_booking_halong.action + arr_html[2] + "/charter.html";
                document.form_check_booking_halong.submit();
